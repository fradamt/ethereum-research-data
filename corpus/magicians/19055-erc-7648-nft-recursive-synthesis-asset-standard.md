...
category: ERCs
tags: [nft, erc-721]
url: https://ethereum-magicians.org/t/erc-7648-nft-recursive-synthesis-asset-standard/19055
views: 2116
likes: 2
posts_count: 9
---
...
author: MUAdao [contact@muadao.build](mailto:contact@muadao.build)
...
Discord： [Discord](https://discord.gg/mua-dao)
...
**tensaix2j** (2024-05-06):

This is an interesting concept. Looking forward to see it implemented.

---

**alimaomao** (2024-05-27):

`https://docs.muadao.build/mua-dao/product/mua7648/erc7648`

could check the doc

---

**alimaomao** (2024-06-10):

```auto
[type or paste code here](https://7648.muaverse.build/hyperdrive)
```

i see a campaign launched on mantle for ERC7648
