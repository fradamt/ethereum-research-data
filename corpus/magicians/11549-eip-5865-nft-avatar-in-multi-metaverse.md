...
category: EIPs
tags: [nft]
url: https://ethereum-magicians.org/t/eip-5865-nft-avatar-in-multi-metaverse/11549
views: 1027
likes: 2
posts_count: 1
---

# EIP-5865: NFT Avatar in Multi-Metaverse

Pull Request: [Add EIP-5865: NFT Avatar in Multi-Metaverse by yeri-lee · Pull Request #5865 · ethereum/EIPs · GitHub](https://github.com/ethereum/EIPs/pull/5865/files)
...
Under “avatars,” metadata keys for any metaverse platform, such as [Zep.us](http://Zep.us) and Another.world, can be added. The value included in the key will define the animation of a character.
