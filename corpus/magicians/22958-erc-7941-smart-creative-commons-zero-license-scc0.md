...
source: magicians
topic_id: 22958
title: "ERC-7941: Smart Creative Commons Zero License (SCC0)"
author: zhous
date: "2025-02-22"
category: ERCs
tags: []
url: https://ethereum-magicians.org/t/erc-7941-smart-creative-commons-zero-license-scc0/22958
views: 247
likes: 7
posts_count: 10
---

# ERC-7941: Smart Creative Commons Zero License (SCC0)
...
contract SCC0LicenseManager is Ownable {
    ...
    constructor(License[] memory _licenseList,address _initOwner) Ownable(_initOwner) {
        for (uint256 i = 0; i 0, "SCC0LicenseManager: error params");
...
Hey [@zhous](/u/zhous) thanks for sharing! Quick question:

Given that proxy upgradeable smart contracts can suffer from storage slot collisions—potentially allowing a public constant like LICENSE to be overridden—would it be more secure to implement SCC0 compliance verification using delegate call opcodes? What are the trade-offs or challenges of switching to an opcode-based delegate call approach in this context?

---

**zhous** (2025-03-10):

There’s no risk you worried in this license.

It’s published on Github and we’re still working on this EIP:

https://github.com/DAism2019/SCC0
...
please tell me what relation do I have to this license

---

**zhous** (2025-04-09):

[github.com](https://github.com/DAism2019/SCC0)




  ![image](https://opengraph.githubassets.com/cf0c7d3da8db528ece74d7333e0bff39/DAism2019/SCC0)
...
SCC0 (Smart Creative Commons Zero) is the first public goods license designed for decentralized public applications (Smart Commons), which includes dApps, dAIpps, and various types of AIs.

---

**undefined** (2025-04-14):

![](https://ethereum-magicians.org/user_avatar/ethereum-magicians.org/zhous/48/1298_2.png) zhous:

> […] ensuring the following core principles:
> AI-led Governance: Rules are enforced via smart contracts (such as rejecting interactions with non-compliant applications and prohibiting private token distributions), with AI gradually taking over the governance process.

Why is this a property that should be enforced? It seems orthogonal to the rest of the goals of the license and I think the license should otherwise be compatible with license-holders making their own judgment of how which entities should have what authority? Why is it desired for human governance be incompatible with this license?

The two AI-related points under the Motivation section similarly seem orthogonal and unrelated to the rest.

Why not break this apart into (at least) two proposals?

---

**zhous** (2025-04-16):

Looking ahead, we believe that the development and management of all applications—the latter including protocol rules, security audits, reviews, etc.—should be handed over to AIs. In other words, any application that cannot be managed by AIs will become obsolete.

However, the conditions needed for this future do not exist today. For instance, there is currently no public AI capable of taking on such management responsibilities. Therefore, without a doubt, we still need humans to develop it. This development process may require some innovative dApps as auxiliary tools, and these innovative dApps will also need to be built by humans. Yet, all these developments will serve as crucial building blocks for the future ecosystem. This also means that, at some point in the future, they too must be handed over to AI’s management.

Thus, this license must be grounded in the future while accommodating the present reality where humans remain the primary owners.

---

**zhous** (2025-04-29):

We are now trying to develop V3 of this license. v3 focuses on the ethical governance of AI, so we’re expected to discuss with top AI teams on how to govern AI using the SCC0 License.

BTW,



      [github.com/ethereum/ERCs](https://github.com/ethereum/ERCs/pull/906)
...
####
      ...
      `master` ← `zhous:master`
          ...
          [+573
            -0](https://github.com/ethereum/ERCs/pull/906/files)
...
SCC0 (Smart Creative Commons Zero) is the first public goods license tailored fo[…](https://github.com/ethereum/ERCs/pull/906)r decentralized public applications (Smart Commons), including dApps, dAIpps(AIs). This standard introduces a structured way for smart contracts to declare SCC0 compliance, enabling automated on-chain verification and governance integration.

---

**wjmelements** (2025-06-25):

The title of this thread should be ERC-7941. It appears to be a typo.

---

**zhous** (2025-07-22):

Don’t know why the number has to be changed.
