...
source: magicians
topic_id: 18158
title: "Add ERC: Contract signature validation extension for ERC-3009 Transfer with Authorization"
author: yzhang1994
date: "2024-01-16"
category: ERCs
tags: [erc, account-abstraction]
url: https://ethereum-magicians.org/t/add-erc-contract-signature-validation-extension-for-erc-3009-transfer-with-authorization/18158
views: 1440
likes: 2
posts_count: 2
---

# Add ERC: Contract signature validation extension for ERC-3009 Transfer with Authorization

From developers at [circlefin](https://github.com/circlefin), we are proposing a new extension for ERC-3009 Transfer with Authorization, which has already been added to USDC v2.2.
...
Good idea. Introducing support for smart contract wallet signature validation enhances the standard’s adaptability, accommodating different signature schemes and algorithms.
