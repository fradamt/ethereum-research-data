...
category: EIPs
tags: [nft]
url: https://ethereum-magicians.org/t/eip-draft-ricardian-nft-royalty/11763
views: 1464
likes: 3
posts_count: 6
---

# EIP Draft: Ricardian NFT Royalty
...
Feedback welcome here or on twitter: https://twitter.com/skogard
...
[Comprehensive guide on writing and submitting an EIP | by Anett | The Fellowship of Ethereum Magicians | Medium](https://medium.com/ethereum-magicians/comprehensive-guide-on-writing-and-submitting-an-eip-9474163771f0)
...
I’m using “agreement” instead of “license” because it’s more generalized, and what we’re using at Kali&Lex.

The value I see by sharing the agreement’s hash onchain is not the ability to lookup the agreement. Rather, it’s to have the agreement’s hash onchain.

From that perspective, I recommend:

- A URI query standard after the hash. See File:URI syntax diagram.svg - Wikipedia and Query string - Wikipedia .
- Standard agreement abbreviations in the URI query. For instance, “ipfs://…?cc=bysa&ta=rs” .

Minor suggestions:

- Change name to “Ricardian Agreement NFT” .
- Change “licenseURI” to “agreementURI” .

Errata:

![](https://ethereum-magicians.org/user_avatar/ethereum-magicians.org/skogard/48/7793_2.png) skogard:
...
A friction I see with onchain hash `if ( hash1 == hash2 )` utility:

- filled out templates will have a different hash than each other and the template

My suggestion is to use ERC-1155 patterns to handle templates. Some onchain-friendly nested structure where parent template begets children instances.

---

**Joe** (2022-11-30):

Good idea! But why can’t I find this draft in EIP site? Is it merged?
...
Interesting straightforward implementation! This also leaves the contract to purely real world enforcement, right (geographies, discovery of misuse etc)?

I’ve seen similar ideas, this comes to mind - how do you think they interoperate/differ:



    ![](https://ethereum-magicians.org/letter_avatar_proxy/v4/letter/r/f07891/48.png)
    [EIP-5553 - Representing intellectual property on chain with Royalty Portions](https://ethereum-magicians.org/t/eip-5553-representing-intellectual-property-on-chain-with-royalty-portions/10551) [EIPs](/c/eips/5)
