...
source: magicians
topic_id: 14872
title: "EIP: Token Revenue Sharing"
author: quyphan
date: "2023-06-29"
category: EIPs
tags: [erc, token]
url: https://ethereum-magicians.org/t/eip-token-revenue-sharing/14872
views: 2003
likes: 3
posts_count: 4
---

# EIP: Token Revenue Sharing
...
contract ERC7254 is Context, IERC7254, IERC7254Metadata {
    ...
    function _burn(address account, uint256 amount) internal virtual {
        ...
        unchecked {
            ...
            // Overflow not possible: amount = amount, "ERC7254: insufficient allowance");
            unchecked {
...
Transfer amount of tokens to the address “to”.
...
Allows the spender to withdraw from your account multiple times, up to the specified amount.

`function approve(address spender, uint256 amount) public returns (bool)`

transferFrom

Transfer amount of tokens from address “from” to the address “to”
...
**internetmoneydev** (2023-08-18):

check out post here: [Continuous Dividend Production Token](https://ethereum-magicians.org/t/continuous-dividend-production-token/14191)

implementation can be found here: [TIMEDividend (0xCA35638A3fdDD02fEC597D8c1681198C06b23F58) - PulseChain Explorer](https://scan.pulsechain.com/address/0xCA35638A3fdDD02fEC597D8c1681198C06b23F58/contracts#address-tabs)

---

**internetmoneydev** (2023-08-21):

The main issues that i see are the following:

- extra info written during low level transfer, 3 bytewords currently. could probably get down to 1
- rounding errors will kill small rewards depending on transfers / re-accounting
