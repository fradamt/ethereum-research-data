...
category: EIPs
tags: [nft]
url: https://ethereum-magicians.org/t/eip-5773-context-dependent-multi-asset-tokens/11326
views: 5033
likes: 14
posts_count: 32
---
...
We are proposing a MultiResource token standard, where one token can be represented by multiple different resources. The whole concept has been outlined in the [RMRK MultiResource documentation](https://docs.rmrk.app/lego2-multi-resource) as well as our EIP:
...
1. Why is a method to get all the assets not included?
...
1. Why is pagination not included?
...
The MultiAsset token standard has been made compatible with [EIP-721](https://eips.ethereum.org/EIPS/eip-721) in order to take advantage of the robust tooling available for implementations of EIP-721 and to ensure compatibility with existing EIP-721 infrastructure.

## Test Cases

Tests are included in [multiasset.ts](https://github.com/ethereum/EIPs/assets/eip-5773/test/multiasset.ts).
...
See [MultiAssetToken.sol](https://github.com/ethereum/EIPs/assets/eip-5773/contracts/MultiAssetToken.sol).

## Security Considerations

The same security considerations as with [EIP-721](https://eips.ethereum.org/EIPS/eip-721) apply: hidden logic may be present in any of the functions, including burn, add asset, accept asset, and more.

Caution is advised when dealing with non-audited contracts.

## Copyright

Copyright and related rights waived via [CC0](https://github.com/ethereum/EIPs/LICENSE.md).

## Replies

**SamWilsn** (2022-11-01):

There are at least two other EIPs that are working on solving similar ideas. One of them is: [EIP-4955: Vendor Metadata Extension for NFTs](https://eips.ethereum.org/EIPS/eip-4955) by [@0xnacho](/u/0xnacho).

---

**SamWilsn** (2022-11-01):

If the pending array order is not preserved when accepting resources, and two `acceptResource` transactions are in-flight, could the owner end up approving a resource they didn’t intend?

I’d maybe suggest not using index directly, or preserving array order, or using a `permit`-style EIP-712 signature to do all the pending changes work off-chain.

---

**ThunderDeliverer** (2022-11-15):

We’ve take a look the the proposals that are addressing similar problems, but we found that they all include at least one of the following limitations:
...
We also reviewed the possibility of doing permit-style EIP-721 signatures, but found that since this proposal extends ERC-721 which already uses 1 transaction for approving operations with tokens. It would be inconsistent to have this and also support signing messages for operations with resources.

---

**SamWilsn** (2022-11-16):

Would it make sense to collaborate with those authors (eg. [@0xnacho](/u/0xnacho))? Do you think your proposal solves the same issues as theirs?

---

**SamWilsn** (2022-11-16):

I think [EIP-4494: Permit for ERC-721 NFTs](https://eips.ethereum.org/EIPS/eip-4494) extends EIP-721 with a permit, so I don’t think it would be unusual to support off-chain signatures.

---

**ThunderDeliverer** (2022-11-16):

I’m not really sure… Our proposal solves the issue that EIP-4955 is tackling, but it also supports a significantly broader spectrum of applications.

You could use EIP-5773 for cross-metaverse compatibility (this is what EIP-4955 tackles), but also for any kind of media consuming dApps (ebooks, music, art,…), and real world applications (realastate, smart cities, collaborative robotics, IoT, …), and probably much more that we haven’t even considered.

---

**ThunderDeliverer** (2022-11-16):

It does and I’ve used it before, but we feel that EIP-4494 could be applied to the EIP-5773 by an implementer. It seems that including this would add additional functionality, but is not necessary for the proposal.

---

**SamWilsn** (2022-11-25):

We’re trying a new process where we get a volunteer peer reviewer to read through your proposal and post any feedback here. Your peer reviewer is [@waichung](/u/waichung)!
...
[@waichung](/u/waichung) please take a look through [EIP-5773](https://eips.ethereum.org/EIPS/eip-5773) and comment here with any feedback or questions. Thanks!

---

**WaiChung** (2022-11-28):

100%. I’m in the middle of it.

---

**WaiChung** (2022-11-28):

Hi [@ThunderDeliverer](/u/thunderdeliverer),

I dug into the implementation of MultiAssetToken.sol and have some questions regarding the _addAssetEntry and _addAssetToToken APIs. I don’t see those APIs being consumed anywhere so I’m just wondering if there’re more files you can share with me so I can get a holistic view of the implementation. I look forward to your reply. Cheers!

---

**ThunderDeliverer** (2022-11-29):

Hi [@WaiChung](/u/waichung),

thank you for prompt review. We have an example repository with all of our “legos”. The MultiAsset lego is our implementation of EIP-5773 and you can take a look at it here: [evm-sample-contracts/README.md at master · rmrk-team/evm-sample-contracts · GitHub](https://github.com/rmrk-team/evm-sample-contracts/blob/master/contracts/MultiAsset/README.md)

We also provide a user journey for MultiAsset that uses both here: [evm-sample-contracts/multiAssetUserJourney.ts at master · rmrk-team/evm-sample-contracts · GitHub](https://github.com/rmrk-team/evm-sample-contracts/blob/master/scripts/multiAssetUserJourney.ts)

I hope this is useful. Cheers!

---

**stoicdev0** (2022-12-01):

The reason we provide them but don’t use them nor include them in the interface is to have a non opinionated  implementation. This is inspired by OpenZeppelin’s implementation of `ERC721`, where for instance `mint` is only included as an internal method (`_mint`), but is up to the final implementer to add it with the right permissioning. We believe this applies exactly to the methods you’re mentioning.

---

**ThunderDeliverer** (2022-12-06):

Hey,

I don’t want to pressure you, but have you managed to go through our proposal yet? Do you have any feedback or additional questions?

---

**WaiChung** (2022-12-07):

apologies. My go live date got brought forward and the whole tech team is in fire fighting mode right now. I will try complete this by this week. Thank you for your patience!

---

**ThunderDeliverer** (2022-12-17):

I hope your live date went as planned ![:smile:](https://ethereum-magicians.org/images/emoji/twitter/smile.png?v=12) Do you have some time available for the review in the near future? We are really looking forward to your feedback!

---

**WaiChung** (2022-12-19):

Thanks for asking! Everything went well. Sorry I wanted to get on it last week but got very sick. I feel better now and will get on the review this week.

---

**WaiChung** (2022-12-21):

Hey [@ThunderDeliverer](/u/thunderdeliverer),

I found some time to review the code this week. I’m currently in the process of doing so. I’ve cloned your code and starting testing what I think are edge cases. If you go to this link [eip-5773/multiasset.ts at master · waichung/eip-5773 · GitHub](https://github.com/waichung/eip-5773/blob/master/test/multiasset.ts) from line 403 to 437. There’s an unexpected error. Could you clarify if this was by design? I’d think that there should be some check in the `_addAssetToToken` method  to prevent this from happening but maybe I’m using it wrongly?

---

**stoicdev0** (2022-12-21):

There’s a bug we discovered 2 weeks ago in the sample implementation but I haven’t taken the time to push the fix to the EIPs repo. It’s related with overwriting so hopefully it’s the same one you’re facing. I’ll do it in the next hours and ping you. Thanks!

---

**stoicdev0** (2022-12-21):

I created the PR already, will try to get it merged soon but in the meantime you can try with the fix from the PR [here](https://github.com/ethereum/EIPs/pull/6202)

I included your failing test and with this fix it passes.  I’m glad you found this problem, it really shows you’re doing a detailed review, thanks [@WaiChung](/u/waichung) !
