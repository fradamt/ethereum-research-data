...
author: vmc-crossmint
date: "2025-01-17"
category: ERCs
tags: []
url: https://ethereum-magicians.org/t/erc-721-verifiable-credential-extension/22562
views: 72
likes: 0
posts_count: 1
---
...
Hi everyone, i would like you feedback on this new ERC.

This is an extension of [ERC-721](https://eips.ethereum.org/EIPS/eip-721) that adds verifiable credential properties at the contract (collection) level. It allows ERC-721 tokens to natively reference and manage on-chain credentials, including W3C Verifiable Credentials, by defining mechanisms for storage, encryption, revocation, and verification.
...
The supportsInterface method MUST return true when called with 0x7861069.
