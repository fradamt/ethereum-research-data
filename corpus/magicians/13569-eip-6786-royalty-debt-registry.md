...
source: magicians
topic_id: 13569
title: "EIP-6786: Royalty Debt Registry"
author: BogdanKTHD
date: "2023-03-27"
category: EIPs
tags: [royalties]
url: https://ethereum-magicians.org/t/eip-6786-royalty-debt-registry/13569
views: 1799
likes: 0
posts_count: 3
---
...
Tests are included in [ERC6786.test.js](https://github.com/BogdanKTHD/EIPs/blob/eip-5666/assets/eip-6786/test/ERC6786.test.js).
...
Copyright and related rights waived via [EIPs/LICENSE.md at master · ethereum/EIPs · GitHub](https://github.com/ethereum/EIPs/blob/master/LICENSE.md).

## Replies

**SamWilsn** (2023-05-16):

Have you looked at [ERC-4910](https://eips.ethereum.org/EIPS/eip-4910)?

---

**BogdanKTHD** (2023-05-17):
