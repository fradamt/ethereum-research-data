...
source: magicians
topic_id: 26677
title: "ERC-8088: Cross-Chain Tracking Standard"
author: baishuo13
date: "2025-11-22"
category: ERCs
tags: []
url: https://ethereum-magicians.org/t/erc-8088-cross-chain-tracking-standard/26677
views: 75
likes: 1
posts_count: 4
---
...
[![Figure-1](https://ethereum-magicians.org/uploads/default/optimized/3X/6/3/635484651000cdd0ed0b79dae75241b14e6ba7ce_2_599x500.png)Figure-12262×1888 434 KB](https://ethereum-magicians.org/uploads/default/635484651000cdd0ed0b79dae75241b14e6ba7ce)

**Figure 1: Simulation of source chain and target chain event generation**

[![Figure-12](https://ethereum-magicians.org/uploads/default/optimized/3X/2/4/2412f479cd6d17249f63731868f715f97299a91a_2_690x452.png)Figure-122790×1830 432 KB](https://ethereum-magicians.org/uploads/default/2412f479cd6d17249f63731868f715f97299a91a)
...
The problem is that many of the existing cross-chain bridges already have the mint/burn permissions for tokens in their current contracts. Modifying and abandoning the entire structure on top of this is very difficult.

---

**baishuo13** (2025-12-04):

There’s no need to modify or abandon the original architecture; this is just an incremental feature (supporting external indexing). Upgrades only require adapting to the current standard and will not affect off-chain infrastructure.

---

**baishuo13** (2025-12-04):

For existing contract, just require an upgrade to use this standard which won’t affect the existing mint/burn permission of tokens
