...
source: magicians
topic_id: 23073
title: "EIP 7908: HD wallet In Treasury Management"
author: Alice
date: "2025-03-06"
category: ERCs
tags: [wallet]
url: https://ethereum-magicians.org/t/eip-7908-hd-wallet-in-treasury-management/23073
views: 200
likes: 3
posts_count: 1
---

# EIP 7908: HD wallet In Treasury Management

Proposed by Ant International: https://www.ant-intl.com/en/

[![image](https://ethereum-magicians.org/uploads/default/optimized/2X/7/776dd6c166f44062e3c0359251ca40ac8d1d3f84_2_690x284.jpeg)image1342×554 61.5 KB](https://ethereum-magicians.org/uploads/default/776dd6c166f44062e3c0359251ca40ac8d1d3f84)
...
5. MUST NOT reuse the same entity_id' across distinct subsidiaries.
6. Department Identifier (department_id')

SHALL be derived by hashing the department name into a hardened index.
7. MUST isolate keys between departments via hardened derivation.
8. Account Index (account_index)
...
entity_index = int.from_bytes(entity_hash[:4], "big") | 0x80000000   # 2^31 ≤ index >
...
[![img](https://ethereum-magicians.org/uploads/default/optimized/2X/a/a66ab492ed20e8e3e6ca3dc5169c74b1a91cdc11_2_690x258.png)img2508×938 323 KB](https://ethereum-magicians.org/uploads/default/a66ab492ed20e8e3e6ca3dc5169c74b1a91cdc11)
