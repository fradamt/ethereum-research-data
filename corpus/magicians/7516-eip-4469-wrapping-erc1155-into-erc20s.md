...
url: https://ethereum-magicians.org/t/eip-4469-wrapping-erc1155-into-erc20s/7516
views: 2257
likes: 1
posts_count: 3
---
...
**tmoindustries** (2024-04-13):

did this ever happen?  or are any active projects doing it?  I have checked sudoswap, 4626, tokenbound, Etherans Items, github, and others and so far have not found it.  Definitely several people talking about it but have not seen it in the wild.

---

**zergity** (2024-04-14):

instead of wrapping, consider deploying ERC20 (on demand) to shadow puppet each 1155’s ID

you can check out the design in this repo, which audited by Hacken: [GitHub - derion-io/shadow-token](https://github.com/derion-io/shadow-token)
