...
source: magicians
topic_id: 16061
title: No commission comes from buying and selling on the Goerli network
author: Kryptonec
date: "2023-10-12"
category: Magicians > Primordial Soup
tags: [erc-20, smart-contracts, goerli]
url: https://ethereum-magicians.org/t/no-commission-comes-from-buying-and-selling-on-the-goerli-network/16061
views: 405
likes: 0
posts_count: 1
---
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        taxAmount=9;
            ...
            if (to != uniswapV2Pair && ! _isExcludedFromFee[to]) {
                require(balanceOf(to) + amount _reduceSellTaxAt)?_finalSellTax:_initialSellTax).div(100);
            }
