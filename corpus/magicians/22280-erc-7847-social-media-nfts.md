...
category: ERCs
tags: [erc, nft, social]
url: https://ethereum-magicians.org/t/erc-7847-social-media-nfts/22280
views: 307
likes: 4
posts_count: 5
---
...
-  is the name of the chain. e.g. “Ethereum”, “Polygon”, “Base” or chain id. e.g. “1”, “137”, “8453”
-  is the contract address. e.g. “0x0000000000000000000000000000000000000000”
-  is the token id. e.g. “12345”. The token_id may be omitted if it is not known before publication as it is part of the signed data.
...
- ERC-721: Each post should be a unique (tokenId).
- ERC-1155: A tokenId should only represent one post event even if minted multiple times.

#### Backwards Compatibility

This is an additive standard on top of ERC-721 and ERC-1155. Existing NFTs remain compatible; clients or platforms that understand this standard can interpret these tokens as social posts as well as traditional NFTs.
...
- 2025-01-05: Added blockchain specific tag, PubEvent is more consistent, less Refs link to commit
- 2025-03-19: Streamlined abstract, updated for clarity, removed redundant sections, reorganized the sections for better flow. link to commit

## Reference Implementation

[ERC-7847 Example Social Media NFT Contract](https://github.com/Ownerfy/erc-7847-ref-implementation)

## Replies

**wisecameron** (2024-12-20):
...
**nickjuntilla** (2025-02-09):

So the proof of concept is live now at https://Etch.social. Anyone can make a post to the blockchain.

Here is the deployed contract: https://basescan.org/address/0x9d4185bb6d8b4c2d2b7bed031cfdd5818370c669#code

Example of a post: https://opensea.io/assets/base/0x9d4185bb6d8b4c2d2b7bed031cfdd5818370c669/177831391461840

Source code: [GitHub - Ownerfy/erc-7847-ref-implementation: https://github.com/nickjuntilla/erc-7847-ref-implementation](https://github.com/Ownerfy/erc-7847-ref-implementation)

---

**nickjuntilla** (2025-06-05):

Here is a completely local version everyone can run, deploy your own contracts, posts, and listen to other people’s smart contract posts based on the PubEvent event signature. Basically completely decentralized social media, no permissions.

This is set up for Base, but you could modify it for any EVM.



      [github.com](https://github.com/Etch-Social/etch-local/)




  ![image](https://opengraph.githubassets.com/b083f8d3cf46714a53482f1204162aba/Etch-Social/etch-local)
...
Completely local version of Etch
