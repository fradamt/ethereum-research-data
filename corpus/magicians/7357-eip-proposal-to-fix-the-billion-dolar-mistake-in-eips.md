...
category: EIPs
tags: [errors]
url: https://ethereum-magicians.org/t/eip-proposal-to-fix-the-billion-dolar-mistake-in-eips/7357
views: 1612
likes: 1
posts_count: 5
---
...
To put more in context the problem with non-controlled external input,  I just “copy-and-paste” my last comment on the ERC-1155 discussion “issue” topic ([ERC: Multi Token Standard · Issue #1155 · ethereum/EIPs · GitHub](https://github.com/ethereum/EIPs/issues/1155)) :
...
**lukehutch** (2021-12-16):

[@PhABC](/u/phabc) is correct, any good implementation of these contracts rejects transactions that are passed `address(0)` into an `address`-typed parameter.
...
[@lukehutch](/u/lukehutch) I agree that good/correct/carefully-developed implementations will have no problem.
