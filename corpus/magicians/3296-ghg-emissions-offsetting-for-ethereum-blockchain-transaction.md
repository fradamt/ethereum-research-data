...
source: magicians
topic_id: 3296
title: GHG Emissions Offsetting for Ethereum Blockchain Transactions
author: ensrationis
date: "2019-05-19"
category: EIPs
tags: []
url: https://ethereum-magicians.org/t/ghg-emissions-offsetting-for-ethereum-blockchain-transactions/3296
views: 1854
likes: 0
posts_count: 5
---

# GHG Emissions Offsetting for Ethereum Blockchain Transactions
...
Energy consumption per transaction: Calculation based on gas consumed and conservative assumptions for energy consumption factor of the mining equipment and grid emission factor for mining the block, which processed the transaction. Or as calculated by digiconomist = 0,094 MWh

Grid emission factor: 0,861 t/MWh

Calculation: 0,0940,861 + 0,094*0,861 = 0,161868 tСО2e
...
To compare, Bitcoin energy consumption and carbon footprint per transaction calculated by digiconomist was not 0,094, but 0,803 MWh.
...
- 0xff2ce19aaa46c8debaac2e195eb898f6dd86c0c46befb26baaf66c94cd35fad8
- 0xa3c60801f82f74e36c471c135d1f2eb6b92ca1c8aa05b8f58ee283ab21b3cbf7
- 0x517efedf6b0eadadf46759b6f9b2d9a64b12fc0bef55b8e124d2319d989d2332
etc.
...
Given the variety of sources of power for Ethereum mining, this seems very difficult.  For example, in Iceland geothermal power is free and renewable.  But it’s unclear how to prove one’s mining came from these sources.

---

**Galenovich** (2019-05-19):

That’s why conservative assumptions are proposed given the fact that the majority of miners are in China *Grid emission factor is assessed conservatively as equal to national grid emission factor for P.R. of China. According to “China’s electricity emission intensity…” equals to 0.861 t/MWh.*. Ideally, the miners should provide trustworthy verified data on energy consumption and grid emission factor, once they don’t we should take a conservative assumption

---

**MadeofTin** (2019-05-21):

Have you had a chance to look at the Finality Gadget for eth1.X? The finality provided is a real opportunity to lower block rewards without sacrificing network security which would also reduce the carbon footprint.

---

**Galenovich** (2019-05-25):

We are trying to follow the technical developments. However, the principal task is to provide trustworthy tool to offset negative environmental impact entirely for Ethereum and other cryptocurrencies
