...
date: "2022-08-18"
category: EIPs
tags: [nft, erc1155, dao, fractionalized, irl]
url: https://ethereum-magicians.org/t/eip-draft-erc1155-asset-backed-nft-extension/10437
views: 2565
likes: 0
posts_count: 2
---

# EIP draft, ERC1155 (asset backed NFT extension)
...
author: liszechung ([@liszechung](/u/liszechung))

discussions-to: [EIP draft, ERC1155 (asset backed NFT extension)](https://ethereum-magicians.org/t/eip-draft-erc1155-asset-backed-nft-extension/10437)
...
**liszechung** (2022-08-19):

For some background info, i am working on a project called Fraktiq, which means fractionalized antique.

It uses ERC1155 for the fractions.

For all IRL assets, there will be a chance to acquire all pieces for a total acquisition, that is why i am proposing. I will work on the code to complete the community also thinks this is useful.

Thank you.

Project site: https://fraktiq.art
