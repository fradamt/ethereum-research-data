...
tags: []
url: https://ethereum-magicians.org/t/operation-router/22633
views: 133
likes: 2
posts_count: 3
---
...
author: Lucas Picollo (), Alex T. Netto (), Nick Johnson ()
status: Draft
...
[![image](https://ethereum-magicians.org/uploads/default/original/2X/9/92dbb0919fed56d9fe0115cbb31421fdb46fc244.png)image669×332 14 KB](https://ethereum-magicians.org/uploads/default/92dbb0919fed56d9fe0115cbb31421fdb46fc244)
...
The HTTP request made to the gateway follows the [same standard proposed by the EIP-3668](https://eips.ethereum.org/EIPS/eip-3668#gateway-interface) where the URL receives `/{sender}/{data}.json` enabling an API to behave just like an smart contract would. However, the EIP-712 Typed Signature was introduced to enable authentication.

[![image](https://ethereum-magicians.org/uploads/default/optimized/2X/6/6e93255bb78da3077db38005d75e9e1ec6b0445a_2_589x500.png)image655×556 24.9 KB](https://ethereum-magicians.org/uploads/default/6e93255bb78da3077db38005d75e9e1ec6b0445a)
...
![](https://ethereum-magicians.org/user_avatar/ethereum-magicians.org/pikonha/48/12738_2.png) pikonha:
