...
source: ethresearch
topic_id: 14133
title: NFT Royalty Enforcing Mechanism
author: snakajima
date: "2022-11-07"
category: Applications
tags: []
url: https://ethresear.ch/t/nft-royalty-enforcing-mechanism/14133
views: 2553
likes: 0
posts_count: 3
---

# NFT Royalty Enforcing Mechanism
...
I published my draft proposal, [Decentralized NFT](https://hackmd.io/@snakajima/BJqG3fkSo) yesterday, and I attached the copy below.
...
**nicszerman** (2022-11-08):

I think a lot of emphasis was given to the proposed changes but you should much further explain what the current problems are.

---

**cybertelx** (2022-11-11):

trustless royalty free marketplaces could still exist without approve(), just that it would be hacky. a theoretical pattern could be like:

- call “register()” on the marketplace contract with the NFT ID & address, the contract would check if the user owns this NFT
- transfer the NFT to the marketplace contract with transfer()
- call another function on the marketplace contract for listing

plus, your idea of blocking approve() would prevent certain useful NFT dapps from working (such as, for example, a bulk transfer dapp)
