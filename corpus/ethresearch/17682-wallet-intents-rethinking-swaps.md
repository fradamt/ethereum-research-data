...
source: ethresearch
topic_id: 17682
title: Wallet Intents - Rethinking Swaps
author: mattstam
date: "2023-12-08"
category: Applications
tags: []
url: https://ethresear.ch/t/wallet-intents-rethinking-swaps/17682
views: 2217
likes: 1
posts_count: 2
---

# Wallet Intents - Rethinking Swaps
...
A quick proof-of-concept: [GitHub - mattstam/safeswap: A proof-of-concept module that allows token swaps directly from your Safe wallet.](https://github.com/mattstam/safeswap)
...
3. If multiple pairs exist on different DEXs, weigh pro/cons of each
4. If concerned with front-running:

Learn how submit Flashbots bundles for private TX
5. Calculate slippage and additional fees to use for the UNI swap
6. Submit swap

###### With SafeSwap:

1. add SwapSwap Module (if not already added)
2. Calculate the appropriate about of WETH for the UNI
3. Submit swap
