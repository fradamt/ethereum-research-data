...
source: ethresearch
topic_id: 8472
title: The Great Alaskan Transaction Pipeline
author: lithp
date: "2021-01-08"
category: Execution Layer Research
tags: [stateless]
url: https://ethresear.ch/t/the-great-alaskan-transaction-pipeline/8472
views: 3768
likes: 6
posts_count: 17
---
...
https://twitter.com/jadler0/status/1172241504502452226

---

**pipermerriam** (2021-01-08):
...
Interesting. I guess one way to make this work is to always charge transactions their GAS_LIMIT, no matter the actual gas used?
...
> one way to make this work is to always charge transactions their GAS_LIMIT, no matter the actual gas used
...
A better idea might be to execute transactions immediately, but include the witness *in the next block*.
...
In 2019 and early 2020, we discussed Alexey and Igor’s breakthorugh experiments ([1](https://medium.com/@akhounov/data-from-the-ethereum-stateless-prototype-8c69479c8abc), [2](https://medium.com/@akhounov/the-shades-of-statefulness-in-ethereum-nodes-697b0f88cd04), [3](https://medium.com/@mandrigin/stateless-ethereum-binary-tries-experiment-b2c035497768), [4](https://medium.com/@mandrigin/semi-stateless-initial-sync-experiment-897cc9c330cb)) which made statelessness feasible by using a cache of recent witness data.
...
Also, thank you for adding the context here [@poemm](/u/poemm), this is great!

---

**kladkogex** (2021-01-12):
...
> It is possible to pre-process the transaction queue and predict the results of executing any candidate transaction, so miners will be 100% capable of knowing ahead of time whether the transactions they are including are valid.
