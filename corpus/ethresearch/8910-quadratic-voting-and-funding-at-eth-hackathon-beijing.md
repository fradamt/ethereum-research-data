...
source: ethresearch
topic_id: 8910
title: Quadratic Voting and Funding at ETH Hackathon Beijing
author: toyotomie
date: "2021-03-12"
category: Economics
tags: []
url: https://ethresear.ch/t/quadratic-voting-and-funding-at-eth-hackathon-beijing/8910
views: 2678
likes: 0
posts_count: 5
---
...
In the end, there were 11207 votes casted to 19 projects, 341.19BNB donated from community (worth ~74,000 USD), 5x larger than the 61.5BNB prize pool (worth ~$14,000) sponsored by Binance Smart Chain. A summary of the results is [here](https://twitter.com/DoraHacks/status/1368534363734822915), a real-time leaderboard of the quadratic funding grant is on [HackerLink](https://hackerlink.io/en/Grant/HACKATHON/Round/1/detail).
...
**Multimyst** (2021-03-12):

This is an excellent job，I am a community booster in this campaign, and I feel ashamed of that.Because some teams don’t have community capacity, they don’t get 1/10 of the prize money of the top teams, which is very unfair to the developers.

However, I have also seen some improvements in the way quadratic voting is done, such as voting as
...
We think we can complicate the model by saying that the judges will have 50% of the prize distribution and the crowd will have the remaining 50%.

More complex vote counting mechanisms can also be used in the model. Thus allowing the best teams to stand out

---

**owocki** (2021-03-14):

Hi from Gitcoin,  I’m in a telegram group with a few other devs building QF implementations.  Hit me up if you want an invite.

Is there a place we can see data associated with this campaign?  I’d be curious to see amount donated + num contributors on a project by project basis.

---

**toyotomie** (2021-03-14):

The 50%-50% split is a good proposal. Actually we can deploy two smart contracts, one for quadratic voting, another for judge voting, and put the results together on the HackerLink leaderboard.

Tuning the curve can definitely change voter behavior. However, if the slope is too sharp, the community might be suppressed to vote.

Can you elaborate more on “more complex vote counting mechanisms”?

---

**toyotomie** (2021-03-14):

I’m happy to join & discuss improvements of QF implementations. There are several topics we are interested in, e.g. DID / white listing solutions, anti-sybil mechanisms, MACI implementation, tuning parameters to make the game fairer, etc.

There is a real-time leaderboard listing every project’s votes, community donation and sponsor subsidy pool matching amount. Currently we are also building a tool for projects to get access to voting results (address / votes).
