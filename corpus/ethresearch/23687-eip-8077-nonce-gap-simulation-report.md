...
source: ethresearch
topic_id: 23687
title: "EIP-8077: Nonce Gap Simulation Report"
author: leobago
date: "2025-12-17"
category: Sharding
tags: [data-availability, rollup, p2p]
url: https://ethresear.ch/t/eip-8077-nonce-gap-simulation-report/23687
views: 136
likes: 2
posts_count: 1
---
...
### 1.4 Key Implications for EIP-8077

| Finding | Implication for EIP-8077 |
| --- | --- |
| Up to 36% gap rate | A significant portion of blob transactions were affected without smart fetching |
...
| --- | --- | --- |
| Very High | 0.15 | Extreme concentration on a few senders (e.g., major L2s like Base, Optimism) |
...
[![transactions_over_time](https://ethresear.ch/uploads/default/optimized/3X/d/5/d5ae667fa4a3908ae1f99ad76a131d18707ba648_2_690x321.png)transactions_over_time1753×817 34.5 KB](https://ethresear.ch/uploads/default/d5ae667fa4a3908ae1f99ad76a131d18707ba648)
...
The probability of a transaction being sent by the sender `i` follows an exponential distribution:
...
[![transaction_distribution](https://ethresear.ch/uploads/default/optimized/3X/4/e/4e166ae653607ad009f03097d3922f175775d388_2_690x372.png)transaction_distribution1514×817 71.2 KB](https://ethresear.ch/uploads/default/4e166ae653607ad009f03097d3922f175775d388)

*Figure 2: Probability distribution showing how transaction frequency varies across senders for different skewness levels.*

[![transactions_per_sender](https://ethresear.ch/uploads/default/optimized/3X/f/4/f4cc8017d4f5d4f035b71b342e2fce63ab9ecd36_2_690x364.png)transactions_per_sender1547×817 76.7 KB](https://ethresear.ch/uploads/default/f4cc8017d4f5d4f035b71b342e2fce63ab9ecd36)
...
[![sender_distance_boxplot](https://ethresear.ch/uploads/default/optimized/3X/f/d/fd1483aba030b917a8be74eb952dfece9a6fadd6_2_690x387.png)sender_distance_boxplot1494×840 43.6 KB](https://ethresear.ch/uploads/default/fd1483aba030b917a8be74eb952dfece9a6fadd6)
...
[![nonce_gap_heatmap](https://ethresear.ch/uploads/default/optimized/3X/8/b/8b9c687977bf06fe6e79f7e2cc05d7a92197ef2c_2_568x500.png)nonce_gap_heatmap1217×1071 60.6 KB](https://ethresear.ch/uploads/default/8b9c687977bf06fe6e79f7e2cc05d7a92197ef2c)
...
| Up to 36% blob transactions affected | Significant efficiency gains are possible with smart fetching |
...
The code can be found here: [eth-research/EIP-8077 at main · migalabs/eth-research · GitHub](https://github.com/migalabs/eth-research/tree/main/EIP-8077)

The simulation is implemented in `EIP-8077/simu.py` with the following components:

| Function | Purpose |
| --- | --- |
| get_sender_distribution() | Generates a probability distribution for sender selection |
...
| plot_sender_distance_boxplot() | Shows the distribution of same-sender transaction distances |

**Configurable Parameters** (at top of `EIP-8077/simu.py`):
