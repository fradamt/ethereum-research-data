...
source: ethresearch
topic_id: 7717
title: Zkopru (zk optimistic rollup) for private transactions
author: Wanseob-Lim
date: "2020-07-19"
category: zk-s[nt]arks
tags: [zkop-rollup]
url: https://ethresear.ch/t/zkopru-zk-optimistic-rollup-for-private-transactions/7717
views: 13352
likes: 56
posts_count: 5
---
...
[![zkopru transaction](https://ethresear.ch/uploads/default/optimized/2X/7/7d555c11d3ac74c4a0db6106b16f805428556127_2_525x500.png)zkopru transaction1447×1377 215 KB](https://ethresear.ch/uploads/default/7d555c11d3ac74c4a0db6106b16f805428556127)
...
[![image](https://ethresear.ch/uploads/default/optimized/2X/7/7ca5c3fb18baa85ea1c4b1f5d9042ba9207103e8_2_564x500.png)image1342×1189 122 KB](https://ethresear.ch/uploads/default/7ca5c3fb18baa85ea1c4b1f5d9042ba9207103e8)
...
[![image](https://ethresear.ch/uploads/default/optimized/2X/d/d592b30cb05b28ecf9628c96d0ff97aeab30ba3e_2_426x375.png)image958×843 71.6 KB](https://ethresear.ch/uploads/default/d592b30cb05b28ecf9628c96d0ff97aeab30ba3e)

#### Mass deposits

[![image](https://ethresear.ch/uploads/default/optimized/2X/f/fbab0542d90ce861f07565468aa53ddd5075f4c0_2_499x375.png)image960×720 28.6 KB](https://ethresear.ch/uploads/default/fbab0542d90ce861f07565468aa53ddd5075f4c0)

#### Mass migrations

[![image](https://ethresear.ch/uploads/default/optimized/2X/7/787be20995fd6d83af417450d2907434d15e1ed5_2_499x375.png)image960×720 50 KB](https://ethresear.ch/uploads/default/787be20995fd6d83af417450d2907434d15e1ed5)
...
[![image](https://ethresear.ch/uploads/default/optimized/2X/5/5a2a3ae10211b52ae7344de4d9dc34336a87488a_2_533x500.png)image1024×959 96.2 KB](https://ethresear.ch/uploads/default/5a2a3ae10211b52ae7344de4d9dc34336a87488a)
...
[![image](https://ethresear.ch/uploads/default/optimized/2X/0/09dcea1b401e618fa321a78362c7105c48149620_2_690x437.png)image958×608 31.8 KB](https://ethresear.ch/uploads/default/09dcea1b401e618fa321a78362c7105c48149620)
...
[![grove](https://ethresear.ch/uploads/default/optimized/2X/c/ca4e3fd77d2d108e0b1e79b8545489123e254a62_2_690x376.png)grove1031×563 66.1 KB](https://ethresear.ch/uploads/default/ca4e3fd77d2d108e0b1e79b8545489123e254a62)
...
Zkopru optimistically updates the trees’ root and verifies when only there exists a challenge. For the challenge, it generates an on-chain fraud-proof using the subtree rollup methodology. Subtree rollup appends a fixed size of subtrees instead of appending items one by one. When if the subtree’s depth is 5, it will append 32 items at once. If it contains only 18 items, the remaining 14 items will have remained forever as zeroes. This subtree rollup dramatically reduces the gas cost about 20 times compared to the rollup. To check the source code, please go to [contracts/controllers/challenges/RollUpChallenge.sol](https://github.com/zkopru-network/zkopru/blob/c386f7510a9a45ce5ca93012c6124bc94723a0ce/packages/contracts/contracts/controllers/challenges/RollUpChallenge.sol). And to see how the subtree works please go to [packages/contracts/contracts/libraries/Tree.sol](https://github.com/zkopru-network/zkopru/blob/9a2e7fe361bdba7be7241d9f80f9e9afbf8ae76c/packages/contracts/contracts/libraries/Tree.sol#L275)

[![subtree-rollup](https://ethresear.ch/uploads/default/optimized/2X/7/7fd022be927d62031a6aea5f3b6f514ed6b741d6_2_690x299.png)subtree-rollup959×416 27.1 KB](https://ethresear.ch/uploads/default/7fd022be927d62031a6aea5f3b6f514ed6b741d6)
...
Just like the UTXO tree, Zkopru optimistically updates the nullifier tree’s root. If there is any problem, we can prove a nullifier used more than one by generating a fraud-proof on-chain. To see how it works, please see [RollUpChallenge.sol](https://github.com/zkopru-network/zkopru/blob/c386f7510a9a45ce5ca93012c6124bc94723a0ce/packages/contracts/contracts/controllers/challenges/RollUpChallenge.sol) and [SMT.sol](https://github.com/zkopru-network/zkopru/blob/c386f7510a9a45ce5ca93012c6124bc94723a0ce/packages/contracts/contracts/libraries/SMT.sol).
...
> We can have a decentralized open market for the instant withdrawal fee. To follow up this, please subscribe this github issue, Open market for the instant withdrawal prepayment · Issue #33 · zkopru-network/zkopru · GitHub
...
With this specification, we’ve successfully built the testnet using Circom, Solidity, Typescript and etc.
      ...
      [github.com](https://github.com/zkopru-network/zkopru)




  ![image](https://ethresear.ch/uploads/default/optimized/3X/1/e/1e78fc89b416e40eb7b24ec8d4de2424a9792021_2_690x344.png)
...
Truly amazing work and congrats on the release!

---

**zmanian** (2020-07-20):

This is incredibly impressive. I can barely believe it’s real.

Also massive congrats to the Circom teams work which is doing a lot of heavy lifting behind the scenes.

---

**Wanseob-Lim** (2020-07-20):

Thank you [@vbuterin](/u/vbuterin) [@zmanian](/u/zmanian)! I 100% agree with that Circom absolutely made this possible ![:smiling_face_with_three_hearts:](https://ethresear.ch/images/emoji/facebook_messenger/smiling_face_with_three_hearts.png?v=14)

Not tried yet the new snarkjs lib from Circom team but heard that it became super simpler to build an applied zkp app on it.

---

**Wanseob-Lim** (2020-07-21):

Here is the telegram chat group link to keep discussions about Zkopru.

https://t.me/zkopru

If you want to do something on Zkopru, please join this group and let’s have some chat.
