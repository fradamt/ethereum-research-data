...
source: ethresearch
topic_id: 18563
title: Intent based bridge between L2s and Ethereum powered by multi-proof storage proofs
author: unbalancedparenthese
date: "2024-02-05"
category: Layer 2
tags: []
url: https://ethresear.ch/t/intent-based-bridge-between-l2s-and-ethereum-powered-by-multi-proof-storage-proofs/18563
views: 4713
likes: 6
posts_count: 3
---
...
Authors: [@rcatalan98](/u/rcatalan98) and [@unbalancedparenthese](/u/unbalancedparenthese)
...
[![](https://ethresear.ch/uploads/default/optimized/2X/a/a30bc29313a33e3679ed4c345298b1cd74cdfe35_2_690x419.png)2346×1428 543 KB](https://ethresear.ch/uploads/default/a30bc29313a33e3679ed4c345298b1cd74cdfe35)
...
**TrapedCircuit** (2024-02-05):

Is the strorage proof provider Trustless?

---

**unbalancedparenthese** (2024-02-05):

What do you mean by the storage proof provider being trustless? Storage proof are proven by a zk/validity proof prover. The verifier verifies the proofs.

We can use multiple storage proof providers (herodotus, axiom, etc) or even our own with [Lambdaworks](https://github.com/lambdaclass/lambdaworks).

That said, storage proofs are just an optimization to make the transfer cheaper once it has enough transactions.
