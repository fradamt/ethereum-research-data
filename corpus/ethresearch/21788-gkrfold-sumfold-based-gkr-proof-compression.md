...
source: ethresearch
topic_id: 21788
title: "GKRFold: SumFold-based GKR Proof Compression"
author: 0xvon
date: "2025-02-19"
category: zk-s[nt]arks
tags: []
url: https://ethresear.ch/t/gkrfold-sumfold-based-gkr-proof-compression/21788
views: 453
likes: 3
posts_count: 2
---
...
Masato Tsutsumi (Waseda University) ([X: grandchildrice](https://x.com/grandchildrice))

latest version: [GKRFold: SumFold-based GKR Proof Compression - HackMD](https://hackmd.io/@grandchildrice/SkXoyK1qkl)
...
[![image](https://ethresear.ch/uploads/default/optimized/3X/8/1/816aa53f7413c7549825196fb284bb8bf12b8f07_2_690x386.png)image1414×793 69.8 KB](https://ethresear.ch/uploads/default/816aa53f7413c7549825196fb284bb8bf12b8f07)
...
[![image](https://ethresear.ch/uploads/default/optimized/3X/f/f/fff85dd0b0ce8636efb877626cd21da3794afb95_2_690x204.png)image1557×461 20.6 KB](https://ethresear.ch/uploads/default/fff85dd0b0ce8636efb877626cd21da3794afb95)

We define a Sumcheck instance \mathsf{SC} that contains all the information required for a Sumcheck proof as follows:

![Screenshot from 2025-02-16 11-17-05](https://ethresear.ch/uploads/default/original/3X/d/8/d8da6849890dc78c206f6533dc39141806b6eb6f.png)
...
2. (b) Reconstruct Q(b) by applying the function F to the collection \{f_1(b,x), \dots, f_t(b,x)\}.
3. Commit to the polynomial Q(b). This commitment effectively aggregates the commitments for all n Sumcheck instances.
4. The verifier selects a random challenge r_b and designates the $r_b$th Sumcheck instance as the folded instance.

[![image](https://ethresear.ch/uploads/default/optimized/3X/5/6/56833550908b004448c2cb449ce3d3caee4468f6_2_609x500.png)image757×621 28.5 KB](https://ethresear.ch/uploads/default/56833550908b004448c2cb449ce3d3caee4468f6)
...
[![Screenshot from 2025-02-16 11-15-57](https://ethresear.ch/uploads/default/optimized/3X/5/f/5fa57b64d2d3284bf312541489541842f04d9fb4_2_447x500.png)Screenshot from 2025-02-16 11-15-57600×671 49 KB](https://ethresear.ch/uploads/default/5fa57b64d2d3284bf312541489541842f04d9fb4)
...
[![image](https://ethresear.ch/uploads/default/optimized/3X/7/f/7f642f15ca7dfa204e949207543d1a119a996279_2_389x500.png)HJo8TwWqkg.png556×714 43.5 KB](https://ethresear.ch/uploads/default/7f642f15ca7dfa204e949207543d1a119a996279)
...
F(g_1(x), g_2(x)) = g_1(x) \cdot g_2(x).
4. The vector \vec{g} is instantiated as follows:

SC$_1$: \{ add_{i+1}(z,x,y),\, g_e(x,y,z) \}
5. SC$_2$: \{ add_{i+1}(z,x,y),\, g_e(x,y,z) \}
6. SC$_3$: \{ mult_{i+1}(z,x,y),\, V_{i+1}(y) \}
7. SC$_4$: \{ h_{1,i+1}(x),\, V_{i+1}(x) \}
8. SC$_5$: \{ h_{2,i+1}(y),\, V_{i+1}(y) \}
9. SC$_6$: \{ h_{3,i+1}(x),\, V_{i+1}(x) \}
10. Verify that for all i = 1, \dots, n,
...
11. The verifier evaluates the input layer V_d(r_d).
...
[![image](https://ethresear.ch/uploads/default/optimized/3X/8/6/86818e261db7481628cd5fedee36cecaab27ec47_2_690x114.png)Byo7m_W51l.png1123×186 32.2 KB](https://ethresear.ch/uploads/default/86818e261db7481628cd5fedee36cecaab27ec47)
...
Your research on GKRFold: SumFold-based GKR Proof Compression is truly impressive! The application of SumFold to compress multiple GKR proofs into a single Sumcheck instance is a fascinating optimization that significantly reduces verification overhead.

I’m curious—how do you see this approach evolving in practical implementations? Do you anticipate its integration into mainstream SNARK/STARK frameworks, and what challenges might arise when adapting it to real-world applications?

Thanks again for sharing this groundbreaking work!
