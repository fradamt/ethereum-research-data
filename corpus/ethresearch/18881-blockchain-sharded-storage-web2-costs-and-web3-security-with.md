...
tags: []
url: https://ethresear.ch/t/blockchain-sharded-storage-web2-costs-and-web3-security-with-shamir-secret-sharing/18881
views: 4382
likes: 9
posts_count: 3
---
...
> with Reed–Solomon Error Correcting Code
...
![Architecture](https://ethresear.ch/uploads/default/original/2X/1/1ab0332f7dab1781881337c04b8cf2b3ac63d00b.svg)
...
![Commissioning](https://ethresear.ch/uploads/default/original/2X/7/77872ededb46880dbc4b3836eaf37fadc41dc1da.svg)
...
![Decommissioning](https://ethresear.ch/uploads/default/original/2X/7/72662c68d033b46b2f37a8e365d6e706cd0cf31d.svg)
...
> Economic Model section describes it in more detail.
...
We use the technique described in [Space-Time Tradeoff](#space-time-tradeoff-and-plotting-11) to achieve this.
...
![Mixings](https://ethresear.ch/uploads/default/original/2X/d/d79ee25c1598642029f46f1a0159e2041bad7b6e.svg)
...
![Soundness](https://ethresear.ch/uploads/default/original/2X/2/2052a5ebb746aee4dcae4babcc561158e0f5cc53.svg)

For example, if p=1/2, k=64, n=512, m=3, then this solution achieves 115 bits of statistical security.

## Economic Model

All nodes receive the same reward for storing the data or maintaining the free space, which is the same complexity due to [complexity leveling](#complexity-leveling-and-protection-against-centralized-supernodes-23).

The first source of rewards is token emission with a Bitcoin-like formula. Rewards are distributed to the nodes using [proof of space-time mining](#space-time-tradeoff-and-plotting-11), like in the Chia Network.
...
*Crossposting with [zeropoolnetwork/sharded-storage](https://github.com/zeropoolnetwork/sharded-storage/blob/9b4f7ef7b3e286a64dca59f01fa348b781dd3509/article/main.md)*.

## Replies

**snjax** (2024-06-01):

What do you mean by asking about the rules?

---

**0xwitty** (2024-10-23):

How might the implementation of Shamir’s Secret Sharing in blockchain storage systems influence the scalability and efficiency of decentralized applications, particularly in real-world use cases?
