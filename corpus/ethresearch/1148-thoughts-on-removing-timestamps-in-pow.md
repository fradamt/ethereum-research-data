...
source: ethresearch
topic_id: 1148
title: Thoughts on removing timestamps in PoW
author: taoeffect
date: "2018-02-19"
category: Mining
tags: []
url: https://ethresear.ch/t/thoughts-on-removing-timestamps-in-pow/1148
views: 2027
likes: 0
posts_count: 1
---

# Thoughts on removing timestamps in PoW
...
- The block reward algorithm is now modified to issue coins into perpetuity (no maximum). Any given block can issue up to X number of coins per block.
