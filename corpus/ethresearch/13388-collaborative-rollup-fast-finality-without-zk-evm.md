...
category: Layer 2
tags: []
url: https://ethresear.ch/t/collaborative-rollup-fast-finality-without-zk-evm/13388
views: 1734
likes: 4
posts_count: 6
---
...
[![co1](https://ethresear.ch/uploads/default/optimized/2X/c/c0a383146ff4abfae662e228f49f8a8476bc612a_2_517x255.jpeg)co11096×542 91.7 KB](https://ethresear.ch/uploads/default/c0a383146ff4abfae662e228f49f8a8476bc612a)
...
The probability wanted P(\lceil\frac{2}{3}n\rceil \le X \le n)  follows cumulative hypergeometric distribution, which, when N is large, degrades to binomial distribution:

P(\lceil\frac{2}{3}n\rceil \le X \le n)=\sum_{i=\lceil\frac{2}{3}n\rceil}^n{n \choose i}p^i(1-p)^{n-i}
...
n=32 \rightarrow P=4.5 \times 10^{-5}

n=64 \rightarrow P=3.3 \times 10^{-8}

n=128 \rightarrow P=5.6 \times 10^{-15}
...
The states in L2 can be organized as a Verkle tree, which uses KZG as its state commitment and also implements trie just as MPT. Therefore, the state root is the commitment of the whole tree. We use Verkle tree here because it has smaller proofs than Merkle tree(O(log_kN) vs. O((k-1)log_kN) ), given a k-ary tree of N leaves).
...
Interesting idea, another solution for rollup. When will we have demo for this?

---

**kevinho** (2022-08-17):

Another solution for rollup.

It’s practical solution before zkevm production, like to hear the review of  community.

When will we are going to have demo for this.

---

**zhangliang7190** (2022-08-17):

waiting for the demo，maybe this is a better way for rollup

---

**Bald.Fan** (2022-08-17):

waiting for some use cases~~ and why it is better than other rollups?

---

**PeterWLovQpp** (2022-08-19):

Is the factor “1/3” fixed? Or is there another option?
