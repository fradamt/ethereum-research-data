...
source: ethresearch
topic_id: 3453
title: Quark–gluon Plasma - verified Plasma chain without confirmation signatures
author: shamatar
date: "2018-09-21"
category: Layer 2 > Plasma
tags: [new-extension]
url: https://ethresear.ch/t/quark-gluon-plasma-verified-plasma-chain-without-confirmation-signatures/3453
views: 3327
likes: 5
posts_count: 10
---
...
Always up-to-date draft is located [here](https://github.com/matterinc/research/tree/master/zkSNARKs/zkSNARKgovernedPlasma).
...
> In such zkSNARK public inputs are the following:
>
>
> Old state
> New state
...
One small episode of teamwork of the author and the team was fixed in slack and available via the [link](https://docs.google.com/document/d/1Uw2aRFyF0eRQi-aRr42bsk6NObo-fogCLNwTz2S0fRo/edit).

Also, I am ready to grant guest access to the Slack thread for any interested member, it’s enough to ping me in telegram [@igor_gulamov](https://t.me/igor_gulamov).
...
- since an exit request from l1 has last sent at height  l2
...
**bharathrao** (2018-09-26):

FYI, our project has an account based plasma called Gluon Plasma running on testnet. We have been calling it Gluon Plasma since [Apr 2018](https://www.youtube.com/watch?v=iCL1DwCvTus)
