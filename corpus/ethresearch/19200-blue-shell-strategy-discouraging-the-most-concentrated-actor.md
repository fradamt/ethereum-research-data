...
source: ethresearch
topic_id: 19200
title: Blue shell strategy - discouraging the most concentrated actor as an optimal path
author: themandalore
date: "2024-04-03"
category: Proof-of-Stake > Economics
tags: []
url: https://ethresear.ch/t/blue-shell-strategy-discouraging-the-most-concentrated-actor-as-an-optimal-path/19200
views: 1444
likes: 3
posts_count: 1
---
...
**the plan - a writhing criticism of an EIP should teach them a lesson**
...
**the desired outcome - self inflicted antitrust laws**
...
This article should be a great starting place for continuing discussions with stakeholders and developers in the Ethereum ecosystem as to the best path forward. With[talks of reduced ETH issuance/ staking targets](https://ethresear.ch/t/reward-curve-with-tempered-issuance-eip-research-post/19171), we must recognize that the threats from concentrated actors are too large to ignore and must be handled before we can seriously discuss an equilibrium or even the economics of staking without external influences.

[![](https://ethresear.ch/uploads/default/optimized/2X/3/36e7b442aeebd6ecf028a4aed86b442e5f0a9b83_2_125x130.png)860×860 155 KB](https://ethresear.ch/uploads/default/36e7b442aeebd6ecf028a4aed86b442e5f0a9b83)
